...
$tabs.Size          = New-Object System.Drawing.Size(1160, 300)
...
$grid.Location          = New-Object System.Drawing.Point(10, 320)
$grid.Size              = New-Object System.Drawing.Size(1160, 340)
$grid.ReadOnly          = $true
...
$lblStatus.Location     = New-Object System.Drawing.Point(10, 670)
...
$txtC_Location.Width  = 350

$btnC_Submit          = New-Object System.Windows.Forms.Button
$btnC_Submit.Text     = "Create / Append Role"
$btnC_Submit.Location = New-Object System.Drawing.Point(550, 60)
$btnC_Submit.Size     = New-Object System.Drawing.Size(200, 40)
...
$txtU_NewRole.Width    = 350

$btnU_Submit          = New-Object System.Windows.Forms.Button
$btnU_Submit.Text     = "Update Role Name"
$btnU_Submit.Location = New-Object System.Drawing.Point(550, 80)
$btnU_Submit.Size     = New-Object System.Drawing.Size(200, 40)
...
$txtD_Role.Location = New-Object System.Drawing.Point(200, 58)
$txtD_Role.Width    = 350

$btnD_Submit          = New-Object System.Windows.Forms.Button
$btnD_Submit.Text     = "Delete Role"
$btnD_Submit.Location = New-Object System.Drawing.Point(580, 55)
$btnD_Submit.Size     = New-Object System.Drawing.Size(160, 40)
...
$txtR1_Hero.Width    = 350

$btnR1_Submit          = New-Object System.Windows.Forms.Button
$btnR1_Submit.Text     = "Load Hero Roles"
$btnR1_Submit.Location = New-Object System.Drawing.Point(520, 55)
$btnR1_Submit.Size     = New-Object System.Drawing.Size(200, 40)
...
$btnRA_Submit.Size     = New-Object System.Drawing.Size(160, 40)
...
# -----------------------------
# Grid selection -> populate details (your main ask)
# -----------------------------

$grid.Add_CellClick({
    param($sender, $e)

    if ($e.RowIndex -lt 0) { return } # header click
    ...
    $lblStatus.Text = "Selected hero '$hero' and role '$role'. Details populated in tabs."
})
