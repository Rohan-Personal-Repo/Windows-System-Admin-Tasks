...
$form.RightToLeftLayout = $false   # no mirroring [web:242]
...
$list.GridLines     = $true
$list.HotTracking    = $false   # no hyperlink-style hover
$list.HoverSelection = $false   # no auto-select on hover 
$list.HideSelection = $false
$list.Font          = $fontRow
$list.OwnerDraw     = $true          # necessary for custom centering [web:237]
$list.RightToLeft   = [System.Windows.Forms.RightToLeft]::No

$null = $list.Columns.Add("actorName",       320, [System.Windows.Forms.HorizontalAlignment]::Center)
$null = $list.Columns.Add("roleName",        320, [System.Windows.Forms.HorizontalAlignment]::Center)
$null = $list.Columns.Add("seriesMovieName", 520, [System.Windows.Forms.HorizontalAlignment]::Center)
$null = $list.Columns.Add("roleAddress",     360, [System.Windows.Forms.HorizontalAlignment]::Center)

$form.Controls.Add($list)

# ---------- Owner-draw column headers ----------
...
# ---------- Center ListView items & subitems ----------
# Center ListView items
# $list.Add_DrawItem({
#     param($s,$e)

#     # Always draw same background, ignore hover
...
# Live search (no caret hacks; text types normally)
