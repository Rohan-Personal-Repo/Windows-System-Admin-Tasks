...
$null = $list.Columns.Add("actorName",       280, [System.Windows.Forms.HorizontalAlignment]::Center)
$null = $list.Columns.Add("roleName",        260, [System.Windows.Forms.HorizontalAlignment]::Center)
$null = $list.Columns.Add("seriesMovieName", 420, [System.Windows.Forms.HorizontalAlignment]::Center)
$null = $list.Columns.Add("roleAddress",     280, [System.Windows.Forms.HorizontalAlignment]::Center)
...
$list.Add_DrawItem({
    ...
    $brush = New-Object System.Drawing.SolidBrush($list.ForeColor)
    $e.Graphics.DrawString(
        $e.Item.Text,
        $fontRow,
        $brush,
