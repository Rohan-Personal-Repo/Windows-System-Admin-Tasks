...
# Update actor multiple values: set actorShowName and push new role
...
# Delete a role by hero name from all actors
...
# Normalize roles to arrays (convert object to array if needed)
