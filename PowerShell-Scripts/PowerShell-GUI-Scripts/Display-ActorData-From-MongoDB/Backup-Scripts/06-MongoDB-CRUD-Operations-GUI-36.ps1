...
$txtSearch.Location = New-Object System.Drawing.Point(300, 26)   # more gap after label
$txtSearch.Width    = 520                                      # wider
$txtSearch.Font     = $fontRow

# Light button – LemonChiffon BG, purple text, bold
$btnLight           = New-Object System.Windows.Forms.Button
$btnLight.Text      = "Light"
$btnLight.Location  = New-Object System.Drawing.Point(860, 20)  # gap after textbox
...
$btnDark.Text       = "Dark"
$btnDark.Location   = New-Object System.Drawing.Point(1020, 20)
