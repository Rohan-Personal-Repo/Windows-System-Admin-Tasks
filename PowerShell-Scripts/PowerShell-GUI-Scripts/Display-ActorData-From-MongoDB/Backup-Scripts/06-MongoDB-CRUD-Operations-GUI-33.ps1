...
$list.Location          = New-Object System.Drawing.Point(10, 90)  # 10px below panel
$list.Size              = New-Object System.Drawing.Size(1364, 720)
...
$list.Font              = $fontRow
$list.OwnerDraw         = $false    # no custom drawing → no hover tricks
